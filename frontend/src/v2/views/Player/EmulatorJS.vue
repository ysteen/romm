...
async function onPlay() {
  ...
  try {
    try {
      // The local image contains the pinned nightly frontend, matching cores,
      // and the custom DOSBox Pure save and archive handling.
...
onMounted(async () => {
  ...
  selectedFirmware.value = resolvePlayerFirmware(
    firmwareOptions.value,
    selectedCore.value,
    storedBiosID,
    coreOptions["bios_file"],
  );
